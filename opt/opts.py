...
def parse_opt_test():
    ...
    # Basic
    parser.add_argument('--seed', type=int, default=0, help='random seed')
    parser.add_argument('--location', choices = ['head', 'other', 'head'], help='mouse or other location')
    ...
    parser.add_argument('--output_size', type=int, default=27, help='output size, 27 for mouth, 24 for other, 3 for head')
